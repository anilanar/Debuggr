DEFAULT_PORT = 5858
DEFAULT_IDE_KEY = 'sublime.debuggr'

PACKAGE_PATH = None
PACKAGE_FOLDER = None

FILE_LOG_OUTPUT = 'Debuggr.log'
FILE_BREAKPOINT_DATA = 'Debuggr.breakpoints'
FILE_PACKAGE_SETTINGS = 'Debuggr.sublime-settings'
FILE_WATCH_DATA = 'Debuggr.expressions'
...
REGION_KEY_BREAKPOINT = 'debuggr_breakpoint'
REGION_KEY_CURRENT = 'debuggr_current'
REGION_KEY_DISABLED = 'debuggr_disabled'
